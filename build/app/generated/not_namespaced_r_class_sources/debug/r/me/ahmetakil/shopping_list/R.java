...
public final class R {
  ...
  public static final class styleable {
     ...
     * <tr><td><code>{@link #ColorStateListItem_alpha me.ahmetakil.shopping_list:alpha}</code></td><td>Alpha multiplier applied to the base color.</td></tr>
     * </table>
     ...
     * <p>May be a floating point value, such as "<code>1.2</code>".
     *
     * @attr name me.ahmetakil.shopping_list:alpha
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #CoordinatorLayout_keylines me.ahmetakil.shopping_list:keylines}</code></td><td>A reference to an array of integers representing the
     * locations of horizontal keylines in dp from the starting edge.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_statusBarBackground me.ahmetakil.shopping_list:statusBarBackground}</code></td><td>Drawable to display behind the status bar when the view is set to draw behind it.</td></tr>
     * </table>
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name me.ahmetakil.shopping_list:keylines
     */
     ...
     * "<code>#<i>aarrggbb</i></code>".
     *
     * @attr name me.ahmetakil.shopping_list:statusBarBackground
     */
     ...
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_anchor me.ahmetakil.shopping_list:layout_anchor}</code></td><td>The id of an anchor view that this view should position relative to.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_anchorGravity me.ahmetakil.shopping_list:layout_anchorGravity}</code></td><td>Specifies how an object should position relative to an anchor, on both the X and Y axes,
     * within its parent's bounds.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_behavior me.ahmetakil.shopping_list:layout_behavior}</code></td><td>The class name of a Behavior class defining special runtime behavior
     * for this child view.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_dodgeInsetEdges me.ahmetakil.shopping_list:layout_dodgeInsetEdges}</code></td><td>Specifies how this view dodges the inset edges of the CoordinatorLayout.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_insetEdge me.ahmetakil.shopping_list:layout_insetEdge}</code></td><td>Specifies how this view insets the CoordinatorLayout and make some other views
     * dodge it.</td></tr>
     * <tr><td><code>{@link #CoordinatorLayout_Layout_layout_keyline me.ahmetakil.shopping_list:layout_keyline}</code></td><td>The index of a keyline this view should position relative to.</td></tr>
     * </table>
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name me.ahmetakil.shopping_list:layout_anchor
     */
     ...
     * </table>
     *
     * @attr name me.ahmetakil.shopping_list:layout_anchorGravity
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name me.ahmetakil.shopping_list:layout_behavior
     */
     ...
     * </table>
     *
     * @attr name me.ahmetakil.shopping_list:layout_dodgeInsetEdges
     */
     ...
     * </table>
     *
     * @attr name me.ahmetakil.shopping_list:layout_insetEdge
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name me.ahmetakil.shopping_list:layout_keyline
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderAuthority me.ahmetakil.shopping_list:fontProviderAuthority}</code></td><td>The authority of the Font Provider to be used for the request.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderCerts me.ahmetakil.shopping_list:fontProviderCerts}</code></td><td>The sets of hashes for the certificates the provider should be signed with.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderFetchStrategy me.ahmetakil.shopping_list:fontProviderFetchStrategy}</code></td><td>The strategy to be used when fetching font data from a font provider in XML layouts.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderFetchTimeout me.ahmetakil.shopping_list:fontProviderFetchTimeout}</code></td><td>The length of the timeout during fetching.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderPackage me.ahmetakil.shopping_list:fontProviderPackage}</code></td><td>The package for the Font Provider to be used for the request.</td></tr>
     * <tr><td><code>{@link #FontFamily_fontProviderQuery me.ahmetakil.shopping_list:fontProviderQuery}</code></td><td>The query to be sent over to the provider.</td></tr>
     * </table>
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name me.ahmetakil.shopping_list:fontProviderAuthority
     */
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name me.ahmetakil.shopping_list:fontProviderCerts
     */
     ...
     * </table>
     *
     * @attr name me.ahmetakil.shopping_list:fontProviderFetchStrategy
     */
     ...
     * </table>
     *
     * @attr name me.ahmetakil.shopping_list:fontProviderFetchTimeout
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name me.ahmetakil.shopping_list:fontProviderPackage
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name me.ahmetakil.shopping_list:fontProviderQuery
     */
     ...
     * <tr><td><code>{@link #FontFamilyFont_font me.ahmetakil.shopping_list:font}</code></td><td>The reference to the font file to be used.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontStyle me.ahmetakil.shopping_list:fontStyle}</code></td><td>The style of the given font file.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontVariationSettings me.ahmetakil.shopping_list:fontVariationSettings}</code></td><td>The variation settings to be applied to the font.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_fontWeight me.ahmetakil.shopping_list:fontWeight}</code></td><td>The weight of the given font file.</td></tr>
     * <tr><td><code>{@link #FontFamilyFont_ttcIndex me.ahmetakil.shopping_list:ttcIndex}</code></td><td>The index of the font in the tcc font file.</td></tr>
     * </table>
     ...
     * "<code>?[<i>package</i>:]<i>type</i>/<i>name</i></code>".
     *
     * @attr name me.ahmetakil.shopping_list:font
     */
     ...
     * </table>
     *
     * @attr name me.ahmetakil.shopping_list:fontStyle
     */
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name me.ahmetakil.shopping_list:fontVariationSettings
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name me.ahmetakil.shopping_list:fontWeight
     */
     ...
     * <p>May be an integer value, such as "<code>100</code>".
     *
     * @attr name me.ahmetakil.shopping_list:ttcIndex
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #LoadingImageView_circleCrop me.ahmetakil.shopping_list:circleCrop}</code></td><td></td></tr>
     * <tr><td><code>{@link #LoadingImageView_imageAspectRatio me.ahmetakil.shopping_list:imageAspectRatio}</code></td><td></td></tr>
     * <tr><td><code>{@link #LoadingImageView_imageAspectRatioAdjust me.ahmetakil.shopping_list:imageAspectRatioAdjust}</code></td><td></td></tr>
     * </table>
    ...
    /**
     * <p>This symbol is the offset where the {@link me.ahmetakil.shopping_list.R.attr#circleCrop}
     * attribute's value can be found in the {@link #LoadingImageView} array.
     *
     * <p>May be a boolean value, such as "<code>true</code>" or
     * "<code>false</code>".
     *
     * @attr name me.ahmetakil.shopping_list:circleCrop
     */
    public static final int LoadingImageView_circleCrop=0;
    /**
     * <p>This symbol is the offset where the {@link me.ahmetakil.shopping_list.R.attr#imageAspectRatio}
     * attribute's value can be found in the {@link #LoadingImageView} array.
     *
     * <p>May be a floating point value, such as "<code>1.2</code>".
     *
     * @attr name me.ahmetakil.shopping_list:imageAspectRatio
     */
    public static final int LoadingImageView_imageAspectRatio=1;
    /**
     * <p>This symbol is the offset where the {@link me.ahmetakil.shopping_list.R.attr#imageAspectRatioAdjust}
     * attribute's value can be found in the {@link #LoadingImageView} array.
     *
     * <p>Must be one of the following constant values.</p>
     * <table>
     ...
     * </table>
     *
     * @attr name me.ahmetakil.shopping_list:imageAspectRatioAdjust
     */
     ...
     * <colgroup align="left" />
     * <tr><th>Attribute</th><th>Description</th></tr>
     * <tr><td><code>{@link #SignInButton_buttonSize me.ahmetakil.shopping_list:buttonSize}</code></td><td></td></tr>
     * <tr><td><code>{@link #SignInButton_colorScheme me.ahmetakil.shopping_list:colorScheme}</code></td><td></td></tr>
     * <tr><td><code>{@link #SignInButton_scopeUris me.ahmetakil.shopping_list:scopeUris}</code></td><td></td></tr>
     * </table>
    ...
    /**
     * <p>This symbol is the offset where the {@link me.ahmetakil.shopping_list.R.attr#buttonSize}
     ...
     * </table>
     *
     * @attr name me.ahmetakil.shopping_list:buttonSize
     */
    public static final int SignInButton_buttonSize=0;
    /**
     * <p>This symbol is the offset where the {@link me.ahmetakil.shopping_list.R.attr#colorScheme}
     * attribute's value can be found in the {@link #SignInButton} array.
     *
     * <p>May be a reference to another resource, in the form
     * "<code>@[+][<i>package</i>:]<i>type</i>/<i>name</i></code>" or a theme
     ...
     * </table>
     *
     * @attr name me.ahmetakil.shopping_list:colorScheme
     */
    public static final int SignInButton_colorScheme=1;
    /**
     * <p>This symbol is the offset where the {@link me.ahmetakil.shopping_list.R.attr#scopeUris}
     * attribute's value can be found in the {@link #SignInButton} array.
     *
     * <p>May be a reference to another resource, in the form
     * "<code>@[+][<i>package</i>:]<i>type</i>/<i>name</i></code>" or a theme
     ...
     * '\\n' or '\\uxxxx' for a unicode character;
     *
     * @attr name me.ahmetakil.shopping_list:scopeUris
     */
